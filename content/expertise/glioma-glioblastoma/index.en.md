---
title: "Glioma & Glioblastoma Treatment Malaysia"
seoTitle: "Glioma & Glioblastoma Treatment Malaysia | Neurosurgeon KL"
description: "Expert glioma and glioblastoma surgery in Malaysia by Dr Nor Faizal Ahmad Bahuri — Oxford-trained neurosurgeon at KPJ Tawakkal KL. Treatment for low-grade glioma, high-grade glioma (GBM), astrocytoma and IDH-mutant gliomas."
keywords:
  - glioma treatment Malaysia
  - glioblastoma surgery Malaysia
  - glioblastoma specialist KL
  - GBM treatment Malaysia
  - astrocytoma Malaysia
  - brain tumour glioma Malaysia
...
The single most important prognostic marker in glioma. IDH-mutant gliomas (Grades 2–3) behave more favourably — patients are younger, tumours grow slower, and survival is significantly better. IDH-wildtype at Grade 2/3 behaves much like GBM and warrants aggressive treatment.

**MGMT Promoter Methylation**
Predicts response to temozolomide chemotherapy in GBM. Methylated MGMT = better response to chemotherapy, improved survival. This test should be done on every GBM specimen.

**1p/19q Codeletion**
Defines oligodendroglioma. Highly chemosensitive. Significantly better prognosis than astrocytoma.

**TERT Promoter Mutation, EGFR Amplification**
Markers associated with GBM biology and treatment resistance.
...
**Why does extent of resection matter if you can't remove it all?**
Multiple studies confirm that patients with >98% resection survive significantly longer than those with subtotal resection, even though microscopic disease always remains. Reducing tumour bulk:
...
1. Concurrent radiotherapy (60 Gy over 6 weeks) + daily temozolomide chemotherapy
2. Adjuvant temozolomide for 6 cycles
3. Consider tumour treating fields (TTF) device for eligible patients
